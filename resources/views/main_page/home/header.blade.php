                                ...
                                <div class="form-group">
                                    ...
                                    <select name="product_id" id="product" class="form-control select2"
                                        ...
                                        @foreach ($products as $product)
                                            <option
                                                {{ $mainPage->content != null && $mainPage->content->product_id != null && $mainPage->content->product_id == $product->id ? 'selected' : '' }}
                                                value="{{ $product->id }}">{{ $product->name }}</option>
                                        @endforeach
                                        <option
                                            {{ $mainPage->content == null || $mainPage->content->product_id == 0 ? 'selected' : '' }}
                                            value="0">
                                            Maintenance</option>
                                    </select>
                                </div>
